...
install_xcframework "${PODS_ROOT}/SquareInAppPaymentsSDK/SquareInAppPaymentsSDKs/SquareInAppPaymentsSDK.xcframework" "SquareInAppPaymentsSDK" "framework" "ios-arm64" "ios-x86_64-simulator"
